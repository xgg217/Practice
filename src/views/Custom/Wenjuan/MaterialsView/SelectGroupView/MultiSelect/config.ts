...
// 业务组件
import MultiSelect from "@/views/Custom/Wenjuan/MaterialsView/SelectGroupView/MultiSelect/IndexView.vue";
...
import type { TMultiSelectStatus } from "@/views/Custom/Wenjuan/types/config";
